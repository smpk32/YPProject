...
public class PlaceEventPresentation : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject.tag == "Player")
        {
            ...
            {
                GameManager.instance.playerPrefab.transform.position = GameObject.Find("SpawnSpot").transform.Find("spawn3").transform.position;
