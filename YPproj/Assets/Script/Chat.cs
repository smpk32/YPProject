...
public class Chat : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        //usrListView = gameObject.transform.Find("usrListView").gameObject;
    }
    ...
    {
        string fileUrl = "http://192.168.1.142:8080/imgDown?file_nm=" + url;
